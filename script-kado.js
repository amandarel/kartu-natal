// Pastikan DOM sudah siap sebelum menjalankan salju
setTimeout(createSnow, 100);
...
function createSnow() {
    ...
    // Bersihkan salju lama jika ada (untuk mencegah duplikasi)
    container.innerHTML = ''; 
    ...
    for (let i = 0; i < 50; i++) {
        ...
        // POSISI SALJU: 0 sampai 100vw (Lebar Layar Penuh)
